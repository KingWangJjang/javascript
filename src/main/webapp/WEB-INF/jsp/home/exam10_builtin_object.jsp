	...
	<head>
		...
		<script>
			function fun1() {
				...
				arr1[1] = "볼보";
				arr1[2] = "비엠더블유";
				console.log(arr1);		// 객체 내부의 내용을 다 보여준다
				...
				for(var i=0; i<length; i++) {  // length와 arr5.length를 쓰는것은 다르다 // length=4의 값을 갖는다
					console.log(arr5.pop());	// 맨 마지막 요소를 빼내는 기능
				}
				//how2
				arr5 = ["Banana", "Orange", "Apple", "Mango"];
				arr5.forEach(function(value, index) {
					console.log("value:" + value + ", index:" + index)	// 맨 처음 요소부터 빼내는 기능
				});
				
				//요소 교체
				var arr6 = ["Banana", "Orange", "Apple", "Mango"];
				arr6.slice(2, 0, "Lemon", "Kiwi");	// 2: 2번째 값, 0: 교체할 개수	// 삽입
				arr6.slice(1, 1, "오렌지");	// 1: 1번째 값, 1 교채할 개수		// 교체
				console.log(arr6);
			}
