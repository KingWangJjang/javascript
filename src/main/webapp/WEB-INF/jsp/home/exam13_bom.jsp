	...
	<head>
		...
		<script>
			function fun1() {
				...
				console.log(width + "x" + height);  // 사용자가 보는 창의 크기
			}
			
			function fun2() {
				//window.open("https://www.w3schools.com");
				myWindow = window.open("https://www.w3schools.com", "", "width=500,height=300");
			}
			...
			function fun6() {
				window.location.href = "https://www.w3schools.com";	//window는 최상위 객체로 생략 가능
			}
		</script>
	</head>
	<body>
