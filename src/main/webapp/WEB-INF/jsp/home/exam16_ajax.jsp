	...
	<head>
		...
		<script>
			...
			function fun1() {
				...
				console.log("이 실행이 먼저 된다");
			}
			
			function fun2() {
				$.ajax({
					url:"ajaxContent2.do",
					success: function(data) {	//데이터만 요구할때 data만 적어준다 , data에는 {"img":"ice.jpg"} 속성으로 들어온다
	...
	<body>
		...
		<div style="margin-bottom:20px; padding:10px; border-top:1px solid black">
			...
			<div id="div2" style="margin:10px; padding: 10px; border:1px solid black">
				<img id="img2" width="100px" height="100px" src="${pageContext.request.contextPath}/resource/img/ice.jpg"/>
			</div>
		</div>
