	...
	<head>
		...
		<script>
			function fun1() {
				...
				div1.innerHTML += "<img src='${pageContext.request.contextPath}/resource/img/ice.jpg'/>";
			}
			function fun2() {
				console.log("fun2() 실행");
				document.write("<img src='${pageContext.request.contextPath}/resource/img/fire.jpg'/>");
			}
			function fun3() {
				console.log("fun3() 실행");
