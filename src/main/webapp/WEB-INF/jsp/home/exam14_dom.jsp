		...
		<script>
			...
			function fun2() {
				...
				for(var i=0; i<class1.length; i++) {
					class1[i].style.backgroundColor = "purple";
				}
			}
			
			function fun3() {
				var img1 = document.querySelector("#img1");
				img1.src = "${pageContext.request.contextPath}/resource/img/ice.jpg";
			}
			
			function fun4() {
				var div2 = document.querySelector("#div2");
				div2.innerHTML += "<img src='${pageContext.request.contextPath}/resource/img/fire.jpg'/>";
			}
